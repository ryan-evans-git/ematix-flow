...
| 4 | Correlated + `EXISTS`/`NOT EXISTS` + correlated scalar subqueries | Q10, Q16, Q35, Q41, Q69, Q94 | ✅ | ⚠→🐞 **ematix physical-rule regression** (`decorr_probe`, 2026-07-18): DF decorrelates all cleanly to hash Semi/Anti/Mark joins (no quadratic) and vanilla DF runs all 6 — but the **ematix preset** breaks q10/q16/q69/q94 at physical planning (drops an outer column). Not a decorrelation-pass gap; a rule bug. Scope: [`../PHASE_V2_S3_DECORRELATION.md`](../PHASE_V2_S3_DECORRELATION.md). | **S3** |
