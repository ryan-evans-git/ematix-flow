...
## TL;DR — refresh 2026-06-10, Apple M4 Max (14-core, 36 GB)
...
> This refresh replaces the 2026-06-07 tables, which were measured through
> a long-lived benchmark context (shared plan cache + reused
> `SessionContext`). That context made several queries look faster than the
> production path delivers (e.g. Q18 SF=10 showed 20.6 ms — a memoized
> plan, not a cold execution). The numbers below are slower in places and
> honest everywhere.

### SF=1 — ~1 GB · fits in cache

- **Wins (fastest median per query):** ematix-flow **21 / 22**, Polars 1 (Q15 by 0.9%), DuckDB 0, PySpark 0, Postgres 0.
- **Geomean ematix-flow speedup:** 2.36× vs DuckDB · 3.95× vs Polars · 17.12× vs PySpark · 15.73× vs Postgres.
...
- **Wins (fastest median per query):** ematix-flow **20 / 22**, DuckDB 2 (Q05 by 1.7%, Q08), Polars 0, PySpark 0, Postgres 0.
- **Geomean ematix-flow speedup:** 1.33× vs DuckDB · 4.00× (n=21) vs Polars · 11.97× vs PySpark · 21.67× vs Postgres.

| Query | ematix-flow | DuckDB | Polars | PySpark | Postgres |
|---|--:|--:|--:|--:|--:|
| Q01 | **229** | 250 | 547 | 732 | 4,306 |
| Q02 | **25.9** | 39.7 | 417 | 599 | 2,222 |
| Q03 | **121** | 147 | 572 | 2,722 | 3,488 |
| Q04 | **75.6** | 86.4 | 264 | 1,711 | 905 |
| Q05 | 146 | **144** | — | 4,589 | 3,233 |
| Q06 | **47.6** | 75.2 | 56.3 | 205 | 1,373 |
| Q07 | **131** | 139 | 1,287 | 3,737 | 2,188 |
| Q08 | 184 | **169** | 1,172 | 940 | 1,340 |
| Q09 | **258** | 288 | 445 | 2,187 | 7,431 |
| Q10 | **212** | 374 | 3,145 | 2,355 | 3,362 |
| Q11 | **17.4** | 25.1 | 39.7 | 197 | 578 |
| Q12 | **96.4** | 113 | 116 | 826 | 3,542 |
| Q13 | **140** | 242 | 419 | 2,069 | 10,989 |
| Q14 | **83.7** | 127 | 87.4 | 379 | 813 |
| Q15 | **61.5** | 83.6 | 63.0 | 645 | 1,606 |
| Q16 | **56.1** | 58.6 | 169 | 638 | 1,098 |
| Q17 | **108** | 150 | 473 | 3,956 | 5,387 |
| Q18 | **194** | 204 | 589 | 6,953 | 19,846 |
| Q19 | **126** | 190 | 1,264 | 493 | 148 |
| Q20 | **130** | 137 | 265 | 419 | 3,279 |
| Q21 | **217** | 380 | 34,184 | 7,523 | 6,952 |
| Q22 | **38.0** | 119 | 122 | 628 | 203 |

### SF=100 — ~100 GB · out-of-core

- **Wins (fastest median per query):** ematix-flow **15 / 22**, DuckDB 5, Polars 2 (Q14 by 15%, Q15 by 0.1%), PySpark 0, Postgres 0.
- **Geomean ematix-flow speedup:** 1.30× vs DuckDB · 4.92× (n=17) vs Polars · 8.35× vs PySpark · 57.87× (n=6) vs Postgres.

| Query | ematix-flow | DuckDB | Polars | PySpark | Postgres |
|---|--:|--:|--:|--:|--:|
| Q01 | **2,357** | 2,969 | 79,084 | 5,184 | — |
| Q02 | **289** | 534 | 53,109 | 6,697 | 26,054 |
| Q03 | **1,509** | 1,988 | 30,103 | 26,128 | — |
| Q04 | **824** | 1,571 | 6,550 | 10,543 | — |
| Q05 | **1,663** | 2,265 | — | 38,145 | — |
| Q06 | **457** | 906 | 540 | 1,142 | — |
| Q07 | **1,480** | 2,158 | 95,946 | 12,775 | — |
| Q08 | **1,696** | 2,678 | — | 23,610 | — |
| Q09 | **4,514** | 5,419 | 21,438 | 67,105 | — |
| Q10 | 4,683 | **2,764** | — | 24,590 | — |
| Q11 | 278 | **268** | 412 | 5,639 | 60,108 |
| Q12 | **1,063** | 2,249 | 1,112 | 6,482 | — |
| Q13 | **1,948** | 2,743 | 5,114 | 14,442 | 86,674 |
| Q14 | 1,048 | 1,920 | **895** | 2,623 | — |
| Q15 | 891 | 1,383 | **890** | 5,142 | — |
| Q16 | 832 | **432** | 1,809 | 5,012 | 29,144 |
| Q17 | **1,409** | 2,325 | 9,536 | 47,823 | — |
| Q18 | 4,373 | **2,732** | 15,572 | 54,206 | — |
| Q19 | **1,463** | 1,776 | — | 3,101 | 52,107 |
| Q20 | 1,925 | **1,729** | 6,692 | 5,682 | — |
| Q21 | **3,971** | 6,777 | — | 55,583 | — |
| Q22 | **485** | 797 | 1,255 | 5,107 | 16,805 |

> **Provenance.** ematix-flow + DuckDB are fresh isolated runs on this
> Apple M4 Max (2026-06-10) through `examples/tpch_preset_rebench.rs`;
> Polars SF=10 is a fresh 2026-06-10 run of the in-process harness.
> PySpark, Postgres, and the remaining Polars columns are carried from the
> 2026-05-29/31 baselines on the **same machine** — they're engine-stable
> (ematix code changes don't move them) and Spark needs a JVM not
> currently installed. Polars can't run several canonical TPC-H shapes
> (we feed it semantically-identical `q??.polars.sql` variants); Q05
> overflows its default 32-bit row index at SF >= 10 (`—`), and at SF=100
> Polars OOMs on several queries. Postgres ran with a 90 s per-query cap
> at SF=100 — most heavy queries timed out (`—`), so its SF=100 geomean
> covers only the 6 that finished.
...
> runtime-bloom (with HAVING/semi-aware build estimates),
> cardinality-gated Robin-Hood, and scale-relative-broadcast rules —
> exactly what `pip install ematix-flow` gives you, one fresh
> `SessionContext` per query. DuckDB runs at defaults (in-memory
> `read_parquet`).
