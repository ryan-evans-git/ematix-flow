-- Σ.A2 PR 4: TPC-DS schema for the dialect-translator audit.
-- Auto-generated from Apache Spark's TPCDSSchema.scala.
-- 24 standard tables; column types translated CHAR(N) → VARCHAR.
