...
const RUNS = [
  { run_id: "r-9af3", pipeline: "warehouse_etl.ingest_orders",                  status: "succeeded", started_at: ago(m(34)),   duration_ms: 12_410, triggered_by: "schedule" },
  { run_id: "r-9ad9", pipeline: "warehouse_etl.build_sales_mart",               status: "succeeded", started_at: ago(m(48)),   duration_ms: 48_911, triggered_by: "schedule" },
  { run_id: "r-9ada", pipeline: "realtime_orders.stream_orders_to_olap",        status: "running",   started_at: ago(h(2)),    duration_ms: null,   triggered_by: "manual" },
  { run_id: "r-9ac2", pipeline: "feature_store_sync.publish_to_redis",          status: "succeeded", started_at: ago(m(12)),   duration_ms: 2_098,  triggered_by: "schedule" },
  { run_id: "r-9ab0", pipeline: "warehouse_etl.publish_metrics",                status: "succeeded", started_at: ago(m(34)),   duration_ms: 4_311,  triggered_by: "schedule" },
  { run_id: "r-99fc", pipeline: "nightly_reporting.materialize_dashboards",     status: "failed",    started_at: ago(h(7)),    duration_ms: 96_701, triggered_by: "schedule" },
  { run_id: "r-99f8", pipeline: "warehouse_etl.ingest_orders",                  status: "succeeded", started_at: ago(h(2) + m(34)), duration_ms: 11_988, triggered_by: "schedule" },
  { run_id: "r-99e1", pipeline: "warehouse_etl.build_sales_mart",               status: "succeeded", started_at: ago(h(2) + m(48)), duration_ms: 49_200, triggered_by: "schedule" },
  { run_id: "r-99d7", pipeline: "realtime_orders.stream_orders_to_olap",        status: "paused",    started_at: ago(h(8)),    duration_ms: null,   triggered_by: "manual" },
  { run_id: "r-99c4", pipeline: "feature_store_sync.publish_to_redis",          status: "succeeded", started_at: ago(m(27)),   duration_ms: 2_120,  triggered_by: "schedule" },
  { run_id: "r-99b2", pipeline: "warehouse_etl.publish_metrics",                status: "succeeded", started_at: ago(h(2) + m(34)), duration_ms: 4_298, triggered_by: "schedule" },
  { run_id: "r-99a9", pipeline: "warehouse_etl.ingest_orders",                  status: "succeeded", started_at: ago(h(4) + m(34)), duration_ms: 12_511, triggered_by: "schedule" },
  { run_id: "r-998c", pipeline: "warehouse_etl.build_sales_mart",               status: "failed",    started_at: ago(h(4) + m(48)), duration_ms: 38_421, triggered_by: "schedule" },
  { run_id: "r-9971", pipeline: "warehouse_etl.publish_metrics",                status: "succeeded", started_at: ago(h(4) + m(34)), duration_ms: 4_201, triggered_by: "schedule" },
  { run_id: "r-995a", pipeline: "nightly_reporting.send_briefs",                status: "succeeded", started_at: ago(h(24) + m(35)), duration_ms: 31_409, triggered_by: "schedule" },
  { run_id: "r-993f", pipeline: "warehouse_etl.ingest_orders",                  status: "succeeded", started_at: ago(h(6) + m(34)), duration_ms: 12_345, triggered_by: "schedule" },
  { run_id: "r-9921", pipeline: "feature_store_sync.pull_feature_views",        status: "requested", started_at: null,         duration_ms: null,   triggered_by: "manual" },
  { run_id: "r-9908", pipeline: "warehouse_etl.build_sales_mart",               status: "cancelled", started_at: ago(h(12)),   duration_ms: 1_028,  triggered_by: "manual" },
];
