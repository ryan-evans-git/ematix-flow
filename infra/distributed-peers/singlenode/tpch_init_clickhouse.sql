-- ClickHouse's own published TPC-H DDL, vendored VERBATIM (below this
-- header) from ClickHouse/ClickHouse tests/benchmarks/tpc-h/init.sql
-- (master, fetched 2026-07-12) for the load-then-query MergeTree leg.
-- Their init assumes MergeTree as the server default engine; the
-- harness sets default_table_engine accordingly rather than editing
-- this file.
