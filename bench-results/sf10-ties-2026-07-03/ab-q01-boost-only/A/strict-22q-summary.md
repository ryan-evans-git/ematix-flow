...
|------:|----------:|--------:|-----:|----:|:----------------|
| Q01 | 217.26 | 218.16 | 2.83 | 1.30% | 215.6 / 217.8 / 217.2 / 223.0 / 217.3 |

**Sum of medians**: 217.26 ms  (primary, robust to single-run outliers)
**Sum of means**: 218.16 ms  (secondary)
**Median CV**: 1.30%  (noise-floor across invocations)
**Max CV**: 1.30%  (worst-case per-query noise — likely single-run outlier)
