...
Same-process bench: ematix-flow vs DuckDB vs Polars over all 22 TPC-H queries on SF=1 parquet data, 1 timed trials after 0 warmups, single-machine.
...
|------:|------------:|-------:|-------:|:-----|
| Q15  | 45.72 ± 0.00 | 17.13 ± 0.00 | 32.12 ± 0.00 | DuckDB |
